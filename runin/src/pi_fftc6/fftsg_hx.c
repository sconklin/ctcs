...
function prototypes
    void cdft(fft_int, fft_int, fft_float *);
    void rdft(fft_int, fft_int, fft_float *);
    void ddct(fft_int, fft_int, fft_float *);
    void ddst(fft_int, fft_int, fft_float *);
    void dfct(fft_int, fft_float *);
    void dfst(fft_int, fft_float *);
macro definitions
...
{
    void cftfsub(fft_int n, fft_float *a);
    void cftbsub(fft_int n, fft_float *a);
...
void rdft(fft_int n, fft_int isgn, fft_float *a)
{
    void cftfsub(fft_int n, fft_float *a);
    void cftbsub(fft_int n, fft_float *a);
    void rftfsub(fft_int n, fft_float *a);
    void rftbsub(fft_int n, fft_float *a);
    fft_float xi;
...
void ddct(fft_int n, fft_int isgn, fft_float *a)
{
    void cftfsub(fft_int n, fft_float *a);
    void cftbsub(fft_int n, fft_float *a);
    void rftfsub(fft_int n, fft_float *a);
    void rftbsub(fft_int n, fft_float *a);
    void dctsub(fft_int n, fft_float *a);
    void dctsub4(fft_int n, fft_float *a);
    fft_int j;
    fft_float xr;
...
void ddst(fft_int n, fft_int isgn, fft_float *a)
{
    void cftfsub(fft_int n, fft_float *a);
    void cftbsub(fft_int n, fft_float *a);
    void rftfsub(fft_int n, fft_float *a);
    void rftbsub(fft_int n, fft_float *a);
    void dstsub(fft_int n, fft_float *a);
    void dstsub4(fft_int n, fft_float *a);
    fft_int j;
    fft_float xr;
...
void dfct(fft_int n, fft_float *a)
{
    void ddct(fft_int n, fft_int isgn, fft_float *a);
    void bitrv1(fft_int n, fft_float *a);
    fft_int j, k, m, mh;
    fft_float xr, xi, yr, yi, an;
...
void dfst(fft_int n, fft_float *a)
{
    void ddst(fft_int n, fft_int isgn, fft_float *a);
    void bitrv1(fft_int n, fft_float *a);
    fft_int j, k, m, mh;
...
void cftfsub(fft_int n, fft_float *a)
{
    void bitrv2(fft_int n, fft_float *a);
    void bitrv216(fft_float *a);
    void bitrv208(fft_float *a);
    void cftmdl1(fft_int n, fft_float *a);
    void cftrec4(fft_int n, fft_float *a);
    void cftleaf(fft_int n, fft_int isplt, fft_float *a);
    void cftfx41(fft_int n, fft_float *a);
    void cftf161(fft_float *a);
    void cftf081(fft_float *a);
    void cftf040(fft_float *a);
    void cftx020(fft_float *a);
#ifdef USE_CDFT_THREADS
    void cftrec4_th(fft_int n, fft_float *a);
...
void cftbsub(fft_int n, fft_float *a)
{
    void bitrv2conj(fft_int n, fft_float *a);
    void bitrv216neg(fft_float *a);
    void bitrv208neg(fft_float *a);
    void cftb1st(fft_int n, fft_float *a);
    void cftrec4(fft_int n, fft_float *a);
    void cftleaf(fft_int n, fft_int isplt, fft_float *a);
    void cftfx41(fft_int n, fft_float *a);
    void cftf161(fft_float *a);
...
void bitrv2(fft_int n, fft_float *a)
{
    fft_int j0, k0, j1, k1, l, m, i, j, k, nh;
    fft_float xr, xi, yr, yi;
...
void cftb1st(fft_int n, fft_float *a)
{
    fft_int i, i0, j, j0, j1, j2, j3, m, mh;
    fft_float ew, w1r, w1i, wk1r, wk1i, wk3r, wk3i, 
...
void *cftrec1_th(void *p)
{
    fft_int cfttree(fft_int n, fft_int j, fft_int k, fft_float *a);
    void cftleaf(fft_int n, fft_int isplt, fft_float *a);
    void cftmdl1(fft_int n, fft_float *a);
    fft_int isplt, j, k, m, n, n0;
    fft_float *a;
...
void *cftrec2_th(void *p)
{
    fft_int cfttree(fft_int n, fft_int j, fft_int k, fft_float *a);
    void cftleaf(fft_int n, fft_int isplt, fft_float *a);
    void cftmdl2(fft_int n, fft_float *a);
    fft_int isplt, j, k, m, n, n0;
    fft_float *a;
...
void cftleaf(fft_int n, fft_int isplt, fft_float *a)
{
    ...
    void cftmdl2(fft_int n, fft_float *a);
    void cftf161(fft_float *a);
    void cftf162(fft_float *a);
    void cftf081(fft_float *a);
    void cftf082(fft_float *a);
...
{
    fft_int i, i0, j, j0, j1, j2, j3, m, mh;
    fft_float ew, w1r, w1i, wn4r, wk1r, wk1i, wk3r, wk3i, 
...
{
    fft_int i, i0, j, k;
    fft_float ec, w1r, w1i, wkr, wki, wdr, wdi, ss, xr, xi, yr, yi;
